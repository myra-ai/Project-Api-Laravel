                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <span class="es-button-border"
                                                                        style="background:#f71963;display:inline-block;border-radius:0.5rem;width:auto"><a
                                                                            href="{{ url(env('DASH_URL') . '/reset/password?token=' . $token) }}"
                                                                            class="es-button" target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;border-style:solid;border-color:#f71963;border-width:15px 25px 15px 25px;display:inline-block;background:#f71963;border-radius:2px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center">
                                                                            {{ __('Reset Password') }}</a></span>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                ...
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        ...
                                                                        <strong><a target="_blank"
                                                                                href="{{ url(env('DASH_URL') . '/dashboard') }}"
                                                                                style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#111111;font-size:14px">{{ __('Dashboard') }}</a>
                                                                            - <a target="_blank"
                                                                                href="{{ url(env('DASH_URL') . '/help') }}"
                                                                                style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#111111;font-size:14px">{{ __('Help') }}</a></strong>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
